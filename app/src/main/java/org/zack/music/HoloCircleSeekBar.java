...
public class HoloCircleSeekBar extends View {
    ...
    private void initAttributes(TypedArray a) {
        ...
        int wheel_color_attr = a.getColor(R.styleable.HoloCircleSeekBar_wheel_active_color, Color.WHITE);
...
//                .getString(R.styleable.HoloCircleSeekBar_wheel_unactive_color);
        int wheel_unactive_color_attr = a.getColor(R.styleable.HoloCircleSeekBar_wheel_unactive_color, Color.BLACK);
        int pointer_color_attr = a
                .getColor(R.styleable.HoloCircleSeekBar_pointer_color, Color.WHITE);
        int pointer_halo_color_attr = a
                .getColor(R.styleable.HoloCircleSeekBar_pointer_halo_color, Color.BLACK);
...
/*        if (wheel_color_attr != null) {
        ...
        unactive_wheel_color = wheel_unactive_color_attr;
/*        if (wheel_unactive_color_attr != null) {
        ...
        pointer_color = pointer_color_attr;
/*        if (pointer_color_attr != null) {
        ...
        pointer_halo_color = pointer_halo_color_attr;
